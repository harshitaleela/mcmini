...
MCStack::isInDeadlock() const
{
  ...
  */
bool 
MCStack::isInLivelock(const traceElement* trace, int trace_len) const
{
...
MCStack::printRepeatingTransitions(int pattern_len) const
{
  ...
  mcprintf("REPEATING THREAD OPERATIONS\n");
...
void MCStack::getThreadSchedule(traceElement* trace_arr, int& trace_len) const
{
    int i;
